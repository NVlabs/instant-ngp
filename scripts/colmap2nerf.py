...
def parse_args():
	...
	parser.add_argument("--colmap_camera_params", default="", help="intrinsic parameters, depending on the chosen model")
	parser.add_argument("--images", default="images", help="input path to the images. Format: fx,fy,cx,cy,dist..")
